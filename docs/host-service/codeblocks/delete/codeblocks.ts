...
const typescriptCodeShorten = `const hostservicedeleterequest = new HostServiceDeleteRequest();
...
const goCodeShorten = `resp, _ := hostService.Delete(ctx, &v1.HostServiceDeleteRequest{})
fmt.Println(resp)`;
...
const javascriptCodeShorten = `const hostservicedeleterequest = new HostServiceDeleteRequest();
