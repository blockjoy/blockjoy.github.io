...
const typescriptCodeShorten = `const authservicerefreshrequest = new AuthServiceRefreshRequest();
...
const goCodeShorten = `resp, _ := authService.Refresh(ctx, &v1.AuthServiceRefreshRequest{})
fmt.Println(resp)`;
...
const javascriptCodeShorten = `const authservicerefreshrequest = new AuthServiceRefreshRequest();
